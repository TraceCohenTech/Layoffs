...
const COLORS = ['#3b82f6', '#06b6d4', '#10b981', '#f59e0b', '#f97316', '#f43f5e', '#8b5cf6', '#ec4899', '#14b8a6', '#84cc16', '#6366f1', '#a855f7'];
...
export function IndustryChart({ data }: IndustryChartProps) {
  ...
  return (
    ...
    >
      <h2 className="text-lg font-semibold text-slate-100 mb-1">Top Industries</h2>
