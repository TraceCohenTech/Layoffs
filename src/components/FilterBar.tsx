...
export function FilterBar({ filters, onFilterChange, industries, countries, yearMin, yearMax }: FilterBarProps) {
  ...
  return (
    <motion.div
      ...
      className="glass rounded-xl border border-slate-700/50 p-4 mb-8"
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
        ...
        <div className="relative lg:col-span-1">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 bg-slate-800/50 border border-slate-700/50 rounded-lg text-sm text-slate-200 placeholder:text-slate-500 focus:border-blue-500/50 transition-colors"
          />
        </div>
        ...
        <select
          ...
          className="px-3 py-2 bg-slate-800/50 border border-slate-700/50 rounded-lg text-sm text-slate-200 focus:border-blue-500/50 transition-colors"
        >
